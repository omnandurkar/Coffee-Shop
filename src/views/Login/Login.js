...
export default function Login() {
  ...
  const [isLogin, setIsLogin] = useState(true); // State to control rendering
  ...
  if (isLogin) {
      ...
      <div className="text-start">
        <div className="g-font-b">
          <div className="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5">
            <button type="button" className="btn btn-outline-dark btn-lg px-4 me-md-2 text-capitalize" data-bs-toggle="modal" data-bs-target="#loginModal">Login</button>
            <Link to = "/">
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <p className="mt-3">Don't have an account? <button className="btn btn-link btn-sm" onClick={() => setIsLogin(false)}>Sign Up</button></p>
              </div>
            </div>
          </div>
        </div>
    ...
    return (
      <div className="text-start">
        <div className="g-font-b">
          <div className="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5">
            <button type="button" className="btn btn-outline-dark btn-lg px-4 me-md-2 text-capitalize" data-bs-toggle="modal" data-bs-target="#signupModal">Signup</button>
          </div>
        </div>
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <p className="mt-3">Already have an account? <button className="btn btn-link btn-sm" onClick={() => setIsLogin(true)}>Login</button></p>
              </div>
            </div>
          </div>
        </div>
